...
import { FiActivity, FiCircle, FiCode, FiFileText, FiGrid, FiLayers, FiLayout, FiShield, FiWifi } from 'react-icons/fi';
...
export default function Carousel({
  ...
  return (
    <div
      ref={containerRef}
      className={`relative overflow-hidden p-4 bg-[#01003D] ${
        round ? 'rounded-full border border-white' : 'rounded-[24px] border border-white'
      }`}
      style={{
        width: `${baseWidth}px`,
          ...
          return (
            <motion.div
              ...
              className={`relative shrink-0 flex flex-col ${
                round
                  ? 'items-center justify-center text-center bg-[white] border-0'
                  : 'items-start justify-between bg-[#222222] border border-white rounded-[12px]'
              ...
              transition={effectiveTransition}
            >
              <div className={`${round ? 'p-0 m-0' : 'mb-none pt-5 m-auto'}`}>
                <span className="flex h-[60px] w-[60px] items-center justify-center rounded-full bg-[#430084]">
                  {item.icon}
                </span>
              </div>
              <div className="p-5">
