...
import { FaReact, FaNodeJs, FaDocker, FaCss3Alt, FaJava, FaHtml5, FaCube, FaBlender } from "react-icons/fa";
      ...
      >
        ...
        <section>
          <div className="relative min-h-[100vh] sm:min-h-[screen] lg:min-h-[700px] mb-20">
            ...
            <div className="absolute top-1/2 left-1/3 sm:left-1/4 transform -translate-x-1/2 -translate-y-1/2 text-right px-4">
              <h1 className="text-5xl sm:text-6xl lg:text-[10rem] leading-none bg-gradient-to-r 
              ...
              <div className="relative group mt-6 flex flex-col items-end">
                ...
                >
                  <span className="absolute inset-0 rounded-xl bg-gradient-to-r from-orange-300 via-orange-500 to-orange-900 p-[2px] opacity-0 transition-opacity duration-500 group-hover:opacity-100"></span>
        ...
        <ScrollReveal baseOpacity={0} enableBlur={true} baseRotation={2}>
          <section className="w-full min-h-[60vh] py-10 sm:py-20 px-4 sm:px-6 bg-slate-950 mt-10 mb-5">
            <div className="text-center">
              ...
              <h2 className="uppercase text-xl sm:text-2xl lg:text-3xl font-semibold mt-1 mb-10">Educational Game</h2>
                <p className="max-w-3xl mx-auto text-sm sm:text-base lg:text-lg leading-relaxed text-gray-200 mt-6">
                  The DaMath Educational Game is a digital adaptation of the popular Filipino board game designed to enhance students’ mathematical skills through play.
                  The project combines game-based learning with engaging visuals to make math practice interactive and enjoyable. <br /> <br />
                  As part of a team, my main responsibility was 3D modeling and design using Blender,
                  ensuring that the game board and assets were visually appealing and educationally effective.
                </p>
            </div>
        ...
        <ScrollReveal baseOpacity={0} enableBlur={true} baseRotation={2}>
          <section className="w-full min-h-[60vh] py-10 px-4 sm:px-6 bg-slate-950 mt-10 mb-5">
            ...
            <div className="w-full overflow-hidden">
              <ScrollVelocity
                texts={['Project Objectives', 'DaMath', 'Educational Game']}
                velocity={20}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <ul className="mt-10 max-w-3xl mx-auto space-y-6 sm:space-y-8">
                {[
                  "Promote interactive math learning through gamification.",
                  "Translate the traditional DaMath board game into a digital format.",
                  "Provide students with a fun and visually engaging learning tool.",
                  "Strengthen collaboration skills by working in a team-based academic project."
                ].map((line, idx) => (
        ...
        <ScrollReveal baseOpacity={0} enableBlur={true} baseRotation={2}>
          <section className="py-10 sm:py-20 px-4 sm:px-6 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-2 sm:px-0 lg:px-80">
              
              {/* Users */}
              <SpotlightCard spotlightColor="rgba(0, 229, 255, 0.2)">
                <h3 className="text-lg sm:text-xl font-bold mb-4 flex items-center gap-2 text-white"></h3>
                <ul className="list-disc list-inside text-gray-400 text-sm space-y-2 flex flex-col items-start justify-start">
                  <li>Digital DaMath board and game pieces modeled in 3D (Blender).</li>
                  <li>Player vs Player gameplay with turn-based mechanics.</li>
                  <li>Integrated math operations (addition, subtraction, multiplication, division) within gameplay.</li>
                  <li>UI elements to track moves, scores, and game progression.</li>
                </ul>
              </SpotlightCard>
