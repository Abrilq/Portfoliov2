...
export default function ProjectPage(): ReactElement {
  ...
  const { cardImages, galleryImages } = projectsConfig.drinkingsession;
      ...
      >
        ...
        <section>
          <div className="relative min-h-[100vh] sm:min-h-[screen] lg:min-h-[700px] mb-20">
            ...
            <div className="absolute top-1/2 left-1/3 sm:left-1/4 transform -translate-x-1/2 -translate-y-1/2 text-right px-4">
              ...
              from-orange-600 via-yellow-500 to-pink-600 
              ...
              <div className="relative group mt-6 flex flex-col items-end">
                ...
                >
                  <span className="absolute inset-0 rounded-xl bg-gradient-to-r from-orange-600 via-yellow-500 to-pink-600 p-[2px] opacity-0 transition-opacity duration-500 group-hover:opacity-100"></span>
                  <span className="relative z-10 flex items-center space-x-2">
                    <span className="transition-all duration-500 group-hover:translate-x-1">Drink?</span>
              ...
              {/* Website Link */}
                <div>
                  <h3 className="text-white mt-4">
                    <a href="https://shotpuno.vercel.app/" target="_blank" rel="noopener noreferrer">
                      Want to try it yourself?
                      <p className="bg-gradient-to-r from-orange-600 via-yellow-500 to-pink-600 bg-clip-text text-transparent font-black">
                        Click here!
                      </p>                      
                    </a>
                  </h3>
        ...
        <ScrollReveal baseOpacity={0} enableBlur={true} baseRotation={2}>
          <section className="w-full min-h-[60vh] py-10 sm:py-20 px-4 sm:px-6 bg-slate-950 mt-10 mb-5">
            <div className="text-center">
              ...
              <h2 className="uppercase text-xl sm:text-2xl lg:text-3xl font-semibold mt-none mb-10">Website for the alcoholics</h2>
            ...
            <ScrollReveal baseOpacity={0} enableBlur={true} baseRotation={2}>
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white italic">
                ...
                <p className="max-w-3xl mx-auto text-sm sm:text-base lg:text-lg leading-relaxed text-gray-200 mt-2 mb-10">
                  In Filipino drinking culture, it’s common to share one shot glass around a table. 
                  <br />
                  Once the alcohol sets in, it’s often hard to track whose turn it is to drink.
                  <br />
                  This creates confusion, arguments, or skipped turns.
                </p>
              </ScrollReveal>
            ...
            <ScrollReveal baseOpacity={0} enableBlur={true} baseRotation={2}>
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white italic">
                ...
                <p className="max-w-3xl mx-auto text-sm sm:text-base lg:text-lg leading-relaxed text-gray-200 mt-2 mb-10">
                The Drinking Session Website automates turn-taking. Users input all participants’ names, and every click/tap reveals the next person’s name on screen.
                <br />
                This ensures fairness, fun, and simplicity throughout the session.
                </p>
              </ScrollReveal>
            ...
            <ScrollReveal baseOpacity={0} enableBlur={true} baseRotation={2}>
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white italic">
                ...
                The developer loooooves <span className="bg-gradient-to-r from-orange-500 via-yellow-400 to-yellow-500 bg-clip-text text-transparent uppercase">drinking</span>.
                </p>
              </ScrollReveal>
        ...
        <ScrollReveal baseOpacity={0} enableBlur={true} baseRotation={2}>
          <section className="w-full min-h-[60vh] py-10 px-4 sm:px-6 bg-slate-950 mt-10 mb-5">
            ...
            <div className="w-full overflow-hidden">
              <ScrollVelocity
                texts={['Features of', 'Drinking Session', 'Website']}
                velocity={20}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <ul className="mt-10 max-w-3xl mx-auto space-y-6 sm:space-y-8">
                {[
                  "Input names (add/remove dynamically).",
                  "Arrange/reorder names to set turn order.",
                  "Full-screen display of the next drinker’s name.",
                  "Simple click/tap to reveal the next name.",
                  "Works on both desktop and mobile, so it can be used directly on phones during a session."
                ].map((line, idx) => (
        ...
        <ScrollReveal baseOpacity={0} enableBlur={true} baseRotation={2}>
          <section className="py-10 flex flex-col justify-center items-center">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-3 gap-6 px-4">
              {/* Tech Icons */}
